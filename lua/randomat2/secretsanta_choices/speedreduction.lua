...
CHOICE.Name = "Move Slowly"
CHOICE.Id = "speedreduction"

local speedreduction_mult = CreateConVar("randomat_secretsanta_speedreduction_mult", 0.75, {FCVAR_NOTIFY, FCVAR_ARCHIVE}, "The speed multiplier (0.75 = 75%, a 25% drop).", 0.05, 0.95)
