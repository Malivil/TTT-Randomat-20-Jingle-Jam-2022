...
net.Receive("RdmtSecretSantaWeaponJamsStart", function()
...
net.Receive("RdmtSecretSantaWeaponJamsStop", function()
    if not IsPlayer(client) then
        client = LocalPlayer()
    end
...
net.Receive("RdmtSecretSantaWeaponJamsEnd", function()
    if not IsPlayer(client) then
        client = LocalPlayer()
    end
