...
local butterfingers_time_min = CreateConVar("randomat_secretsanta_butterfingers_time_min", 10, FCVAR_NONE, "Minimum time between weapon drops.", 5, 60)
local butterfingers_time_max = CreateConVar("randomat_secretsanta_butterfingers_time_max", 30, FCVAR_NONE, "Maximum time between weapon drops.", 5, 60)
