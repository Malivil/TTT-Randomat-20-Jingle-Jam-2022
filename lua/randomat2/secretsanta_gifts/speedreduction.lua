...
local speedreduction_mult = CreateConVar("randomat_secretsanta_speedreduction_mult", 0.75, {FCVAR_NOTIFY, FCVAR_ARCHIVE}, "Speed multiplier (0.75=75%, a 25% drop).", 0.05, 0.95)
